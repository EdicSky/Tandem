...
import { displayChange, NameChange } from '../../actions/Maction'

//引入icon
import { AiFillSetting, AiOutlineHome, AiFillPicture } from 'react-icons/ai'
...
function MindexProfile() {
  ...
  // --------------------------------------------------------------------------------------------------
  // 個人資料取值//reducer中控所有的值，運用到所有component
        ...
        >
          <section className="M-avatarTop">
            ...
            <div className="M-avatarDes">
              <h3 onClick={() => dispatch(displayChange(1))}>Kotake</h3>
              <h6>只會爆裂魔法的...</h6>
            </div>
          </section>
          {/* 修改個人資料btn */}
